  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      const label = field.closest('.form-group, .field-wrapper, label')
        ? (field.closest('.form-group, .field-wrapper') || document.body)
            .querySelector('label')
        : null;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אמנון חכמת הקבלה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0b308882-4cc4-4dfc-8284-56399fbe8269',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0b308882-4cc4-4dfc-8284-56399fbe8269';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0b308882-4cc4-4dfc-8284-56399fbe8269';
